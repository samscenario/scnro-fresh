...
-- Users can only create tracks with their own user_id (when authenticated)
...
-- Users can only update their own tracks (when authenticated)
...
-- Users can only delete their own tracks (when authenticated)
