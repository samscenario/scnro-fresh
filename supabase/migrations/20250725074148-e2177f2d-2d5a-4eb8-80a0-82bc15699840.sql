...
-- Keep public read access for tracks (tracks are viewable by everyone)
-- The existing "Tracks are viewable by everyone" policy remains

-- Update tracks table to make user_id NOT NULL for new inserts
-- This ensures all tracks are properly associated with a user
